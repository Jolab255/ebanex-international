...
$institution = htmlspecialchars($data['institution'] ?? 'N/A');
...
$message = "
New Digital Trust Conference Registration received:
...
try {
    if (mail($to, $subject, $message, $headers, $additional_params)) {
        ...
        echo json_encode(["ok" => false, "error" => "The registration service is currently unavailable. Please contact info@ebanexint.co.tz directly."]);
    }
} catch (Exception $e) {
