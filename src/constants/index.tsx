...
export const CORE_SERVICES = [
  {
    ...
    description:
      'Transforming organizational potential through elite professional development and specialized training programs.',
  ...
  },
  {
    ...
    description:
      'Mastering the digital frontier with industry-leading security protocols and technical resilience training.',
  ...
  },
  {
    ...
    description:
      'Cultivating the next generation of institutional leaders through strategic mentorship and adaptive governance.',
  ...
  },
  {
    ...
    description:
      'Strategic consulting to optimize operational frameworks and drive sustainable organizational growth.',
