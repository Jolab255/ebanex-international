...
export const TRAINING_PROGRAMS: Record<string, TrainingProgram> = {
    ...
    evaluation: [
      {
        ...
        desc: 'Baseline knowledge evaluation and skill gap analysis',
      },
      { phase: 'Phase 2: Module Quizzes', desc: 'Interactive quizzes after each learning block' },
      {
        phase: 'Phase 3: Phishing Simulation',
        desc: 'Real-world test of threat recognition skills',
      },
      {
        phase: 'Phase 4: Final Certification',
        desc: 'Comprehensive examination and behavior review',
      },
    ],
    industries: [
  ...
  'ethical-hacking': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Skills Baseline',
        desc: 'Practical assessment of networking and OS fundamentals',
      },
      {
        phase: 'Phase 2: Lab Challenges',
        desc: 'Progressive capture-the-flag (CTF) style technical challenges',
      },
      {
        phase: 'Phase 3: Real-world Simulation',
        desc: 'Full-scale penetration test of a mock enterprise network',
      },
      {
        phase: 'Phase 4: Reporting',
        desc: 'Delivery of a professional-grade executive and technical report',
      },
    ],
    industries: [
      ...
      { title: 'Telecommunications', desc: 'Protecting 5G infrastructure and subscriber data' },
      {
        ...
        desc: 'SCADA/ICS security and industrial control protection',
      },
  ...
  'digital-risk': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Strategy Audit',
        desc: 'Analysis of current organizational risk management maturity',
      },
      {
        phase: 'Phase 2: Risk Modeling',
        desc: 'Developing quantitative models for specific business scenarios',
      },
      {
        phase: 'Phase 3: Board Presentation',
        desc: 'Simulated board meeting presentation of risk posture',
      },
      {
        phase: 'Phase 4: Policy Draft',
        desc: 'Creation of a comprehensive digital risk management policy',
      },
    ],
    industries: [
  ...
  'incident-response': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Triage Test',
        desc: 'Timed assessment of alert validation and initial scoping',
      },
      {
        phase: 'Phase 2: Forensic Challenge',
        desc: 'Deep-dive analysis of memory dumps and network logs',
      },
      {
        phase: 'Phase 3: Live Breach Simulation',
        desc: 'Collaborative team exercise to contain a live "attacker"',
      },
      {
        phase: 'Phase 4: Recovery Planning',
        desc: 'Developing a restoration and hardening strategy',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Participants will get hands-on experience with industry-standard forensic and analysis tools such as Volatility for memory forensics, FTK Imager for disk acquisition, Wireshark for deep packet inspection, and various open-source intelligence (OSINT) tools for threat attribution. We focus on tools that are used in actual high-stakes investigations worldwide.',
      },
      {
        question: 'Is evidence preservation covered?',
        answer:
          'Yes, a fundamental pillar of our curriculum is the preservation of digital evidence and the maintenance of a rigorous chain of custody. We teach the legal and technical requirements for forensic acquisition, ensuring that any evidence your team collects during an incident remains admissible in court and useful for formal regulatory inquiries.',
      },
    ],
  },
  'data-privacy': {
    ...
    testimonial: {
      ...
      image:
        'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=533&fit=crop&crop=faces',
    },
    instructor: {
      name: 'Baraka Opiyo',
      role: 'Executive Director – Training & Capacity Building | Lead Trainer',
    ...
    evaluation: [
      {
        phase: 'Phase 1: Compliance Gap Analysis',
        desc: 'Evaluating current systems against GDPR/Regional standards',
      },
      {
        phase: 'Phase 2: Architecture Review',
        desc: 'Redesigning a mock system using Privacy by Design',
      },
      {
        phase: 'Phase 3: Breach Response Drill',
        desc: 'Handling a privacy-specific data breach scenario',
      },
      {
        phase: 'Phase 4: Audit Readiness',
        desc: 'Compiling an evidence pack for a mock privacy audit',
      },
    ],
    industries: [
  ...
  networking: {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Topology Design',
        desc: 'Creating a high-availability network architecture',
      },
      {
        phase: 'Phase 2: Configuration Lab',
        desc: 'Implementing complex routing and switching scenarios',
      },
      {
        phase: 'Phase 3: Troubleshooting',
        desc: 'Identifying and fixing intentional network breaks',
      },
      {
        phase: 'Phase 4: Capstone Project',
        desc: 'Full deployment of a secure multi-site enterprise network',
      },
    ],
    industries: [
  ...
  'cloud-computing': {
    ...
    testimonial: {
      ...
      image:
        'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=533&fit=crop&crop=faces',
    },
    instructor: {
      name: 'Baraka Opiyo',
      role: 'Executive Director – Training & Capacity Building | Lead Trainer',
    ...
    evaluation: [
      {
        ...
        desc: 'Designing a secure multi-region cloud environment',
      },
      ...
      { phase: 'Phase 3: Automation Test', desc: 'Deploying infrastructure using Terraform' },
      {
        ...
        desc: 'Securing the cloud environment against simulated attacks',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we have a significant module dedicated to container orchestration using Kubernetes. You will learn to manage pods, services, and ingress controllers, as well as how to implement persistent storage and secure container registries within a production-grade cloud environment.',
      },
    ],
  },
  'ai-tech': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: AI Readiness Audit',
        desc: 'Evaluating organizational data and infrastructure maturity',
      },
      {
        phase: 'Phase 2: Prompt Engineering Lab',
        desc: 'Mastering GenAI for complex business tasks',
      },
      {
        phase: 'Phase 3: RPA Prototype',
        desc: 'Building a simple automation for a real business process',
      },
      {
        phase: 'Phase 4: Capstone Pitch',
        desc: 'Presenting an AI-driven innovation project to a mock board',
      },
    ],
    industries: [
  ...
  'digital-transformation': {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 3: Transformation Roadmap',
        desc: 'Developing a step-by-step strategy for a real unit',
      },
      {
        phase: 'Phase 4: Pitch Session',
        desc: 'Defending the transformation strategy to executives',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, this is our most requested corporate in-house program. We can tailor the curriculum to your specific organizational context, allowing your leadership team to work through actual transformation challenges and develop a real-world roadmap as part of the workshop experience.',
      },
      {
        question: 'What is Agile?',
        answer:
          'Agile is a mindset and a set of methodologies (like Scrum or Kanban) that focus on iterative delivery, customer feedback, and continuous improvement. We teach your team how to apply these concepts to business processes, not just software development, to increase your speed and flexibility.',
      },
      {
        question: 'Is there a final project?',
        answer:
          'Yes, every participant or team will develop a comprehensive Digital Transformation Roadmap for their specific unit. This serves as a tangible output of the course that can be presented to your executive board for immediate implementation and funding.',
      },
    ],
  },
  'systems-admin': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Configuration Lab',
        desc: 'Setting up a multi-server directory environment',
      },
      {
        phase: 'Phase 2: Automation Challenge',
        desc: 'Writing scripts to automate routine maintenance',
      },
      {
        phase: 'Phase 3: DR Simulation',
        desc: 'Recovering critical services after a mock failure',
      },
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Absolutely. Virtualization is the backbone of the modern data center. You will get hands-on experience managing hypervisors using VMware vSphere and Microsoft Hyper-V, and we also explore the basics of hyperconverged infrastructure (HCI) to ensure you understand how compute and storage are scaling today.',
      },
      {
        question: 'What scripting languages?',
        answer:
          'We focus on PowerShell for Windows environments and Bash for Linux. We also include a module on Ansible for configuration management, ensuring you can manage hundreds of servers simultaneously through declarative code rather than manual, error-prone command-line entries.',
      },
    ],
  },
  ...
  'it-governance': {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we have a dedicated, up-to-date module on governing emerging technologies such as Artificial Intelligence and Machine Learning. You will learn to implement guardrails that allow for rapid innovation while managing the significant risks associated with bias, privacy, and algorithmic transparency.',
      },
      {
        question: 'Is it theoretical?',
        answer:
          'Not at all. We focus on the practical implementation of major frameworks using real-world scenarios and case studies. You will not just learn what COBIT is; you will practice designing a governance roadmap for a mock organization, identifying decision-making failures, and building performance metrics that work.',
      },
      {
        question: 'What is COBIT?',
        answer:
          'COBIT is a globally recognized framework for the governance and management of enterprise information and technology. It provides a common language for business and IT leaders, ensuring that technology investments deliver the value the organization expects while managing risks at an acceptable level.',
      },
      {
        question: 'Do you provide templates?',
        answer:
          'Yes, every participant receives access to the Ebanex Governance Toolkit, which includes a comprehensive library of policy templates, assessment forms, and dashboard designs for IT performance measurement that you can immediately adapt for your organization.',
      },
    ],
  },
  'risk-management': {
    ...
    evaluation: [
      ...
      { phase: 'Phase 2: Risk Workshop', desc: 'Facilitating a mock risk identification session' },
      {
        ...
        desc: 'Designing an ERM policy for the organization',
      },
      {
        phase: 'Phase 4: Implementation Roadmap',
        desc: 'Creating a plan to embed risk into daily operations',
      },
    ],
    industries: [
    ...
    faqs: [
      {
        ...
        answer:
          "We cover both ISO 31000 and the COSO ERM Framework in depth. We highlight the strengths of each and, more importantly, teach you how to choose and customize a framework that best fits your organization's specific size, industry, and strategic complexity.",
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes, all participants receive a comprehensive set of professional-grade risk registers, policy templates, impact assessment forms, and dashboard designs that can be immediately implemented into their existing organizational workflows.',
      },
      {
        question: 'What is a risk appetite?',
        answer:
          'Risk appetite is the formal statement of the amount and type of risk an organization is willing to take in order to achieve its strategic objectives. You will learn to define this for your institution, ensuring that your management team and board are perfectly aligned on what risks are acceptable and what risks require immediate mitigation.',
      },
      {
        question: 'Does it cover BCP?',
        answer:
          'Yes, we have a significant module dedicated to Business Continuity Planning (BCP) and Disaster Recovery. We teach you how to conduct Business Impact Analyses (BIA) and design recovery strategies that ensure your organization can maintain critical operations regardless of the crisis encountered.',
      },
    ],
  },
  'internal-audit': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Standards Quiz',
        desc: 'Testing knowledge of IIA International Standards',
      },
      {
        phase: 'Phase 2: Audit Program Design',
        desc: 'Creating an audit program for a specific business unit',
      },
      {
        phase: 'Phase 3: Fieldwork Simulation',
        desc: 'Identifying control weaknesses in a mock scenario',
      },
      {
        phase: 'Phase 4: Exit Meeting Pitch',
        desc: 'Communicating findings and recommendations effectively',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we include a comprehensive module on IT auditing specifically designed for non-IT auditors. We believe that in the digital age, every internal auditor must be able to understand and provide assurance on general IT controls and application-level risks without needing to be a specialized system engineer.',
      },
      {
        question: 'Software used?',
        answer:
          'We demonstrate modern auditing techniques using common tools like advanced Excel functions and popular computer-assisted audit software (CAATs). You will learn how to automate data extraction, perform population-wide testing rather than just sampling, and create dynamic visualizations that make your audit reports much more impactful for the Board.',
      },
      {
        question: 'What is COSO?',
        answer:
          "The COSO framework is the global standard for designing, implementing, and conducting internal control. You will learn to use this framework to assess the maturity of your organization's controls across operations, reporting, and compliance, ensuring that your audit function is providing assurance on what truly matters.",
      },
      {
        question: 'Is data analytics covered?',
        answer:
          "Yes, data analytics is a core component of our curriculum. You will learn how to move beyond manual testing to perform continuous monitoring and risk-based data analysis that allows you to identify obscure findings and trends across your organization's entire data set.",
      },
    ],
  },
  compliance: {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Regulatory Scan',
        desc: 'Identifying applicable laws for the organization',
      },
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'ISO 37301 is the international standard for compliance management systems. It provides a formal framework for establishing, developing, implementing, evaluating, maintaining, and improving an effective compliance culture within an organization. We use this standard as the pedagogical spine of our program.',
      },
      {
        question: 'Do you cover RegTech?',
        answer:
          'Yes, we explore the latest technological solutions for automating regulatory monitoring, screening, and reporting. You will learn how to select and implement "RegTech" tools that can significantly reduce the manual workload of your compliance department while improving overall data accuracy and reporting speed.',
      },
    ],
  },
  ...
  leadership: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 2: Role Play Scenarios',
        desc: 'Practicing difficult conversations and coaching',
      },
      {
        phase: 'Phase 3: Strategy Simulation',
        desc: 'Leading a team through a mock organizational crisis',
      },
      {
        phase: 'Phase 4: Action Learning Plan',
        desc: 'Developing a personal growth and team development plan',
      },
    ],
    industries: [
  ...
  'strategic-thinking': {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, every participant receives a personalized "Strategic Thinking Profile" review. We use proprietary diagnostic tools to help you understand your natural decision-making style, your risk tolerance, and any cognitive biases that may be impacting your professional judgment.',
      },
    ],
  },
  communication: {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Communication Audit',
        desc: 'Personal assessment of current communication style',
      },
      {
        phase: 'Phase 2: Recording & Review',
        desc: 'Analyzing personal speaking and presentation habits',
      },
      { phase: 'Phase 3: Roleplay Simulation', desc: 'Handling difficult workplace conversations' },
      {
        phase: 'Phase 4: Capstone Presentation',
        desc: 'Delivering a high-impact professional pitch',
      },
    ],
    industries: [
    ...
    faqs: [
      {
        ...
        answer:
          'Absolutely. We provide specific, proven techniques that help individuals of all personality types communicate authentically and effectively. We focus on building your personal "presence" and giving you the structural tools to organize your thoughts and speak with confidence, without needing to change your core personality.',
      },
      {
        question: 'Covers email writing?',
        answer:
          'Yes, we have a significant, highly practical module dedicated to written professional communication. You will learn to draft high-impact emails, concise reports, and persuasive proposals that get results while maintaining a perfectly professional institutional tone across all digital channels.',
      },
      {
        question: 'Group exercises?',
        answer:
          'The course is over 80% interactive group work, practical drills, and real-time feedback. We believe that communication is a "performing art" that can only be mastered through practice. You will participate in multiple simulations that reflect the high-stakes conversations you face in your specific industry.',
      },
      {
        question: 'What is EQ?',
        answer:
          'Emotional Intelligence (EQ) is the critical ability to recognize, understand, and manage your own emotions, as well as the emotions of those around you. You will learn to use EQ to navigate workplace politics, handle difficult colleagues, and build much more resilient professional relationships.',
      },
      {
        question: 'Do you use video?',
        answer:
          'Yes, we utilize professional video recording and playback for all presentation modules. Seeing yourself "in action" and receiving structured faculty feedback is the most effective way to identify and correct distracting habits while reinforcing your natural communication strengths.',
      },
    ],
  },
  'team-development': {
    ...
    evaluation: [
      {
        phase: 'Phase 1: Team Diagnostic',
        desc: 'Evaluating current team performance and culture',
      },
      { phase: 'Phase 2: Dynamic Mapping', desc: 'Understanding individual roles and strengths' },
      {
        phase: 'Phase 3: Collaboration Drill',
        desc: 'Solving a complex business challenge as a unit',
      },
      {
        phase: 'Phase 4: Charter Development',
        desc: 'Creating a formal team agreement for future work',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'We offer both options depending on your organizational goals. We utilize experiential indoor learning for complex problem-solving modules, and we can incorporate high-impact outdoor components that focus on building grit, resilience, and deep interpersonal trust through physical challenges.',
      },
      {
        question: 'Long-term support?',
        answer:
          'Yes, we don\'t just leave you after the workshop. We offer structured follow-up "pulse" sessions every quarter to review your Team Charter, measure your progress against your new collaboration KPIs, and ensure that the high-performance habits you developed during the intensive remain permanent.',
      },
      {
        question: 'What is Belbin?',
        answer:
          'Belbin Team Roles is a globally recognized methodology for identifying and managing individual strengths within a team. You will learn to recognize the 9 key team roles (such as the "Shaper" or the "Monitor Evaluator") and how to balance these roles to ensure your team is diverse, well-rounded, and effective.',
      },
      {
        question: 'Is it for large groups?',
        answer:
          'We can facilitate groups ranging from 5 to 50 members in this intensive format. For larger departmental sessions, we bring in multiple senior facilitators to ensure that each small group receives the individual attention and guidance needed to make the experiential drills meaningful.',
      },
    ],
  },
  ...
  cisa: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 4: Post-Exam Review',
        desc: 'Detailed analysis of incorrect answers and weak areas',
      },
    ],
    industries: [
    ...
    faqs: [
      {
        ...
        answer:
          'No, exam registration and the voucher cost are separate from the bootcamp fee and must be handled directly through ISACA. However, we provide step-by-step guidance on the registration process, the experience verification requirements, and the best times to schedule your test for maximum success.',
      },
      {
        question: 'Retake policy?',
        answer:
          'We are so confident in our methodology that if you do not pass your CISA exam within 60 days of completing our bootcamp, you are invited to attend our next scheduled bootcamp for free (conditions apply). We are committed to your certification success and will provide additional support to help you master your weak areas.',
      },
      {
        question: 'Is it online?',
        answer:
          'We offer both in-person intensives at our premium training centers and live virtual sessions that utilize high-definition video and interactive polling. Regardless of the format, you will have the same expert faculty and full access to our comprehensive question database and study materials.',
      },
      {
        question: 'How long are the exams?',
        answer:
          'The CISA examination is a rigorous 4-hour session consisting of 150 multiple-choice questions. We have designed our mock exams to simulate this exact timing and pressure, helping you build the mental endurance and time-management skills required to succeed.',
      },
      {
        question: 'What is the pass score?',
        answer:
          'ISACA uses a scaled score system ranging from 200 to 800. A score of 450 or higher is required to pass. Our diagnostic quizzes and mock tests are calibrated to help you accurately predict your performance and ensure you are consistently scoring above this threshold before you sit for the real thing.',
      },
    ],
  },
  cism: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we offer flexible hybrid options that combine live, instructor-led strategic workshops with self-paced domain reviews and access to our massive question database, allowing you to prepare for your certification without taking extensive time away from your leadership duties.',
      },
      {
        question: 'How is it different from CISSP?',
        answer:
          'The CISSP is a broader "gold standard" that covers eight domains of security across the entire IT spectrum. The CISM is a more focused, management-level certification specifically for those who lead and govern information security programs. Many senior professionals find that holding both certifications provides the ultimate competitive advantage.',
      },
      {
        question: 'Are materials provided?',
        answer:
          'Yes, every participant receives the most current ISACA CISM Review Manual, a one-year subscription to our proprietary Ebanex online question database, and our custom-developed "Management Mindset" study guides that are exclusive to Ebanex students.',
      },
    ],
  },
  cissp: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 2: Domain Deep Dives',
        desc: 'Intensive review and testing of all 8 domains',
      },
      {
        phase: 'Phase 3: CAT Mock Exam',
        desc: 'Simulated Adaptive Testing (CAT) mock examination',
      },
      {
        phase: 'Phase 4: Exam Strategy Review',
        desc: 'Fine-tuning response strategy and time management',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, our mock exams specifically simulate the Computerized Adaptive Testing (CAT) format used for English-language CISSP exams. This adaptive format adjusts the difficulty of the next question based on your previous answers, ensuring that the test is a precise measurement of your knowledge across all domains.',
      },
      {
        question: 'Exam voucher?',
        answer:
          'The exam voucher is separate from the bootcamp registration. We assist you with the (ISC)2 registration process and provide guidance on the most strategic time to schedule your formal test based on your performance in our high-fidelity mock examinations.',
      },
      {
        question: 'Can I get an endorsement?',
        answer:
          'Yes, successful candidates must be endorsed by another (ISC)2 certified professional in good standing. Our faculty and the Ebanex professional network are available to assist our successful students with this critical final step in the certification process.',
      },
      {
        question: 'What is the passing score?',
        answer:
          'You must achieve a minimum scaled score of 700 out of 1000. Our diagnostic tools are designed to ensure you are consistently performing at this elite level before we recommend you sit for the formal, high-stakes examination.',
      },
    ],
  },
  ceh: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 2: Vulnerability Lab',
        desc: 'Identifying and exploiting known vulnerabilities',
      },
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, Ebanex always utilizes the most current version of the EC-Council CEH curriculum (currently v12). We ensure that you are training with the latest modules, attack vectors, and toolsets that reflect the reality of the global hacking landscape in 2026.',
      },
      {
        question: 'Practical included?',
        answer:
          'Our bootcamp is designed to prepare you for both the CEH (ANSI) multiple-choice exam and the CEH (Practical) examination. We provide intensive, hands-on labs that mimic the 6-hour practical exam format, ensuring you have the technical mastery required to become a CEH Master.',
      },
      {
        question: 'Prerequisites?',
        answer:
          'EC-Council requires two years of information security work experience or the attendance of authorized training like ours. We provide a full review of your eligibility and guide you through the formal application and examination scheduling process.',
      },
      {
        question: 'Is iLab access included?',
        answer:
          "Yes, every Ebanex student receives 6 months of extended access to EC-Council's official iLabs. This cloud-based range allows you to practice all the modules from the course in a safe, legal environment until you achieve complete mastery of the techniques.",
      },
      {
        question: 'What tools are used?',
        answer:
          'You will work with a massive library of over 3000 hacking tools, including industry standards like Metasploit, Nmap, Wireshark, Burp Suite, and various advanced scanners and exploitation scripts that are used by both professional pen-testers and real-world attackers.',
      },
    ],
  },
  cisco: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 2: Configuration Drills',
        desc: 'Speed-based configuration of core services',
      },
      {
        phase: 'Phase 3: Troubleshooting Lab',
        desc: 'Solving 10 intentional network failures in 2 hours',
      },
    ...
    faqs: [
      {
        ...
        answer:
          'The CCNA is the foundational associate-level certification that covers a broad range of networking concepts. The CCNP is the professional-level certification designed for engineers who want to specialize in high-level enterprise design and complex implementation. We offer tailored bootcamp tracks for both, ensuring you receive the appropriate level of depth for your current career stage.',
      },
      {
        question: 'Physical hardware?',
        answer:
          'Yes, we use a strategic mix of high-end physical Cisco racks and high-fidelity virtualized environments using GNS3 and VIRL. This ensures you gain the tactile experience of cable management and physical port configuration while having the flexibility to build massive, 50-node virtual topologies that reflect carrier-grade networks.',
      },
      {
        question: 'Latest exam versions?',
        answer:
          'Always. Cisco frequently updates their certification domains, and we update our curriculum and lab topologies the very day Cisco announces a change. You can be certain you are training with the exact curriculum required for the most current v1.1 or v2.0 exams.',
      },
      {
        question: 'Is automation covered?',
        answer:
          'Absolutely. Every modern Cisco certification now includes a significant domain on network automation and programmability. Our bootcamp includes dedicated labs on using Cisco DevNet, REST APIs, and Python to manage enterprise-scale networks through code.',
      },
      {
        question: 'What labs are used?',
        answer:
          'We utilize official Cisco Learning Labs as our baseline and supplement them with Ebanex custom-designed high-fidelity topologies that simulate the complex, multi-site network challenges found in African telecommunications and financial hubs.',
      },
    ],
  },
  cdpse: {
    ...
    testimonial: {
      ...
      image:
        'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=533&fit=crop&crop=faces',
    },
    instructor: {
      name: 'Baraka Opiyo',
      role: 'Executive Director – Training & Capacity Building | Lead Trainer',
    ...
    evaluation: [
      {
        ...
        desc: 'Evaluating privacy controls in a mock application',
      },
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, the CDPSE is a technical certification. While it is accessible for DPOs with a strong technical interest, the curriculum is most valuable for IT architects, privacy engineers, and developers who are responsible for the actual design and implementation of privacy controls within systems and platforms.',
      },
      {
        question: 'CDPSE vs CIPP?',
        answer:
          'The CIPP is primarily policy-based and focused on the legal interpretation of privacy laws. The CDPSE is technical and focused on the solution engineering—how to actually build systems that meet those legal requirements. Holding both certifications provides a truly holistic and strategic understanding of organizational privacy.',
      },
      {
        question: 'Work experience?',
        answer:
          'ISACA requires a minimum of three years of professional work experience in at least two of the three CDPSE domains (Privacy Governance, Privacy Architecture, and Data Lifecycle). We provide a thorough experience audit and assist our students with the formal application process.',
      },
      {
        question: 'What are the 3 domains?',
        answer:
          'The certification is structured around three core pillars: Privacy Governance (how the organization manages privacy), Privacy Architecture (how systems are built), and Data Lifecycle (how data is collected, processed, and disposed of).',
      },
      {
        question: 'Are ISACA materials included?',
        answer:
          'Yes, every participant receives the official ISACA CDPSE Review Manual, a one-year subscription to our proprietary Ebanex online question database, and intensive faculty review of the most complex technical privacy patterns.',
      },
    ],
  },
  cia: {
    ...
    faqs: [
      ...
      },
      {
        question: 'Prerequisites?',
        answer:
          "A bachelor's degree or higher (or equivalent) is required for full certification. You must also have a minimum of two years of internal audit experience (or equivalent). However, you can sit for the exams as soon as you have your degree, and our faculty will assist you with the final certification paperwork once your experience requirements are met.",
      },
      {
        question: 'IIA membership?',
        answer:
          'While not strictly mandatory for our bootcamp, we highly recommend becoming a member of the Institute of Internal Auditors (IIA). Membership provides significant discounts on exam registration fees and provides access to a global network of audit professionals and continuing education resources.',
      },
      {
        question: 'Can I take parts separately?',
        answer:
          'Yes, the CIA exams are designed to be taken separately and in any order. Most of our students prefer to take them sequentially (Part 1, then 2, then 3), but we can adjust your study plan if your organizational requirements or personal background make a different order more strategic.',
      },
      {
        question: 'What is the pass mark?',
        answer:
          'The IIA uses a scaled scoring system ranging from 250 to 750. A score of 600 or higher is required to pass each part. Our high-fidelity mock examinations are designed to ensure you are consistently performing at this level before you schedule your official test dates.',
      },
    ],
  },
  crma: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 4: Case Presentation',
        desc: 'Risk assurance strategy for an executive board',
      },
    ],
    industries: [
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, the Certification in Risk Management Assurance (CRMA) is a premier, specialty certification offered by the Institute of Internal Auditors (IIA). It is designed to validate your ability to provide assurance on core business processes in risk management and corporate governance.',
      },
      {
        question: 'Prerequisites?',
        answer:
      ...
      },
      {
        question: 'Is it technical?',
        answer:
          'The CRMA is a management-level assurance certification. While it requires a deep understanding of risk assessment methodologies, it focuses more on the strategic governance and the advisory role of internal audit than on technical IT controls. It is for those who want to lead the risk dialogue within their organization.',
      },
      {
        question: 'How is it different from CIA?',
        answer:
          "While the CIA provides a comprehensive foundation across the entire internal audit spectrum, the CRMA is a deep-dive specialty certification. It focuses exclusively on the audit function's role as a trusted advisor to the Board and management on matters of organizational risk and resilience.",
      },
      {
        question: 'Is there a practical component?',
        answer:
          'Our bootcamp includes intensive, case-based simulations of risk assurance engagements. You will practice designing assurance programs for complex organizational risks, creating high-impact board reports, and defending your risk mitigation priorities in mock executive committee sessions.',
      },
    ],
  },
  conference: {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 4: Post-Event Roadmap',
        desc: 'Applying conference learnings to institutional goals',
      },
    ],
    industries: [
    ...
    faqs: [
      {
        ...
        answer:
          'Our flagship conference is held annually, typically in the third quarter of the year. We announce the specific dates and the host city (which rotates among major African digital hubs) at least six months in advance to allow our global delegates sufficient time for planning and registration.',
      },
      {
        question: 'Virtual options?',
        answer:
          'Yes, we offer a high-fidelity hybrid experience. While the physical event provides unparalleled networking opportunities, our virtual platform allows global participants to engage with all keynote addresses and technical tracks in real-time, complete with interactive Q&A and virtual breakout rooms.',
      },
      {
  ...
  sponsorship: {
    ...
    testimonial: {
      ...
      image:
        'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=533&fit=crop&crop=faces',
    },
    instructor: {
      name: 'Baraka Opiyo',
      role: 'Executive Director – Training & Capacity Building | Lead Trainer',
    ...
    evaluation: [
      { phase: 'Phase 1: Package Selection', desc: 'Aligning sponsorship with business goals' },
      {
        ...
        desc: 'Designing brand and thought leadership presence',
      },
      {
        phase: 'Phase 3: Conference Execution',
        desc: 'Active engagement and visibility during the event',
      },
      {
        phase: 'Phase 4: Post-Event Review',
        desc: 'Measuring ROI and planning future collaboration',
      },
    ],
    industries: [
  ...
  'past-events': {
    ...
    evaluation: [
      ...
      {
        phase: 'Phase 3: Contextual Application',
        desc: 'Applying past lessons to current challenges',
      },
      {
        phase: 'Phase 4: Future Forecasting',
        desc: 'Using historical context for better planning',
      },
    ],
    industries: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, we encourage the use of Ebanex conference materials for academic and professional research. We provide standardized citation formats for all our white papers and keynote addresses to ensure that the intellectual contributions of our faculty and speakers are properly recognized.',
      },
    ],
  },
};
