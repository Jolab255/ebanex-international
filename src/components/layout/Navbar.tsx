...
const Navbar: React.FC = () => {
  ...
  const getContactPath = () => {
    ...
    if (path === '/training') return '/contact?service=Corporate Training';
    if (path === '/it-audit-advisory') return '/contact?service=Strategic Advisory';
    if (path === '/conference') return '/contact?service=Research Partnership';
    if (path === '/about') return '/contact?service=Strategic Advisory';
    if (path.startsWith('/training/')) return '/contact?service=Corporate Training';
    return '/contact';
  };
        ...
        >
            ...
            <div className="flex items-center gap-4 xl:gap-8 h-full">
              <div className="flex items-center gap-3 xl:gap-5 h-full shrink-0">
                <Link
                  to="/"
                  className={cn(
                    'text-[10px] xl:text-[11px] font-black tracking-[0.1em] uppercase transition-colors whitespace-nowrap',
                    location.pathname === '/'
                      ? 'text-[#00BFFF]'
                      : 'text-white hover:text-[#00BFFF]',
                  )}
          ...
          <div className="hidden lg:flex items-center h-full shrink-0 relative z-40 bg-black">
            ...
            <div className="pl-4 sm:pl-6 flex items-center h-full bg-black">
              <Link
                to={getContactPath()}
                className="px-6 py-3 bg-[#00BFFF] hover:bg-white text-black text-[10px] font-black uppercase tracking-[0.2em] rounded-none transition-all shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] active:scale-95 whitespace-nowrap"
              >
                Contact Us
              </Link>
            </div>
          ...
          >
            <div className="p-4 lg:p-6 bg-black/80 backdrop-blur-md shrink-0 border-b border-[#00BFFF]/20 z-20">
              <div className="max-w-7xl mx-auto w-full">
                <motion.div
                  ...
                  transition={{ delay: 0.1 }}
                >
                  <h4 className="text-[10px] font-black text-[#00BFFF] uppercase tracking-[0.3em] mb-1">
                    Overview
                  </h4>
            ...
            >
              ...
              <div className="relative z-10 max-w-7xl mx-auto">
                ...
                >
                  {DROPDOWN_CONTENT[activeDropdown as keyof typeof DROPDOWN_CONTENT].categories.map(
                    (category, idx) => (
                      <motion.div
                        key={idx}
                      ...
                      >
                        <div
                          className={`absolute inset-0 bg-[#00bfff]/20 transform ${idx % 2 === 0 ? 'rotate-1' : '-rotate-1'} group-hover:rotate-0 transition-transform duration-500`}
                        />
                        <div
                          className="relative p-4 lg:p-5 border-[1px] border-[#00BFFF]/30 shadow-2xl transition-all duration-300 h-full flex flex-col group-hover:border-[#00BFFF] group-hover:-translate-y-1"
                          style={{
