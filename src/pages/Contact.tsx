  ...
  return (
    <div className="bg-black min-h-screen text-white overflow-x-hidden">
          ...
          <div ref={infoRef} className="lg:col-span-5 space-y-10">
            <ScrollReveal yOffset={10}>
              <div className="space-y-4">
                <h2 className="text-2xl font-black uppercase border-b-4 border-[#00C4D4] inline-block mb-2">
                  Inquiry Channels
                </h2>
                <p className="text-slate-400 text-base font-medium leading-relaxed">
                  Connect with our specialized departments in Dar es Salaam directly or send us a
                  message for institutional requests.
                </p>
              </div>
            </ScrollReveal>
            ...
            <div className="space-y-5">
              {[
                ...
                >
                  ...
                  <div
                    className="relative p-5 border-[3px] border-black bg-[#0a1628] flex items-center gap-5"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      <span className="text-[9px] font-black uppercase text-[#00C4D4] tracking-widest block mb-0.5">
                        {item.label}
                      </span>
                      <h4 className="font-black text-white uppercase text-xs tracking-tight">
                        {item.title}
                      </h4>
      ...
      <section className="min-h-[40vh] py-16 relative flex flex-col items-center justify-center px-4 overflow-hidden bg-black">
        ...
        <div
          className="max-w-4xl w-full p-10 border-[10px] border-black relative z-10 text-center bg-[#0a1628]"
          style={{ background: 'radial-gradient(circle at 50% 50%, #16476A 0%, #051020 100%)' }}
        >
          <ScrollReveal yOffset={10}>
            <h2 className="text-3xl font-black text-white uppercase mb-5 leading-tight tracking-tighter">
              Ready for <span className="text-[#00C4D4]">Institutional</span> Growth?
            </h2>
          </ScrollReveal>
          <p className="text-white/80 mb-8 max-w-lg mx-auto font-medium uppercase tracking-widest text-[11px] leading-relaxed">
            Our experts are prepared to tailor a solution for your unique operational requirements.
          </p>
          <Link
            to="/training"
            className="inline-flex items-center gap-3 bg-[#00C4D4] border-4 border-black text-black px-8 py-3.5 font-black uppercase text-[10px] tracking-[0.2em] hover:bg-white transition-all"
          >
