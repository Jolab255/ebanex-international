      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-16 sm:mb-24 lg:mb-32">
          ...
          >
            ...
            <h1 className="text-[clamp(1.75rem,5vw,3.75rem)] font-bold font-heading mb-6 sm:mb-8 whitespace-nowrap">The Cyber <span className="text-green-500">Nexus.</span></h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
           {[
             ...
             <div key={idx} className="p-6 sm:p-8 rounded-xl sm:rounded-2xl border border-white/5 bg-slate-900/50 hover:bg-green-500/5 transition-colors">
