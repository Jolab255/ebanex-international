  ...
  return (
    <div className="bg-black min-h-screen text-white">
              ...
              <div className="w-full lg:w-[70%] relative z-40">
                ...
                <div className="inline-flex items-center px-3 py-2 bg-[#00BFFF] text-black mb-6 mt-12 lg:mt-8 ml-8 sm:ml-16 lg:ml-20">
                  <span className="text-[10px] font-black uppercase tracking-[0.1em]">
                    Strengthening Digital Trust Through Independent Assurance and Strategic Insight
                  </span>
                </div>
                ...
                >
                  <div className="relative z-10">
                    <p className="text-base sm:text-lg text-white/90 font-medium leading-relaxed mb-8">
                      Ebanex International provides independent IT audit and advisory services
                      designed to enhance governance, strengthen controls, and support secure
                      digital transformation across organizations.
                    </p>
                    <div className="flex flex-wrap gap-3">
                      <Link
                        to="/contact?service=IT Audit & Advisory"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-5 gap-3 mb-8">
            {approach.map((step, idx) => (
              <div
                key={idx}
                className="relative p-6 border border-[#00BFFF] h-full bg-white/5 backdrop-blur-[2px]"
              >
                <div className="text-3xl font-black text-[#00BFFF] mb-4 tracking-tighter">
                  {step.step}
                </div>
                <h4 className="text-base font-black uppercase mb-3 tracking-tight leading-tight text-white">
                  {step.title}
                </h4>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              <div key={i} className="group relative h-full">
                <div
                  className={`absolute inset-0 bg-[#00bfff] transform ${i % 2 === 0 ? 'rotate-1' : '-rotate-1'} group-hover:rotate-0 transition-transform duration-300`}
                />
                <div
                ...
                >
                  ...
                  <div>
                    <h4 className="text-base sm:text-lg font-black uppercase mb-2 tracking-tight text-white">
                      {item.title}
                    </h4>
      ...
      <CtaSection
        ...
        title={
          <>
            Ready to <span className="text-[#00BFFF]">Strengthen</span> Your{' '}
            <br className="hidden sm:block" /> Control Environment?
          </>
        }
