        ...
        >
          ...
          <div className="space-y-8 text-white/80 font-medium leading-relaxed uppercase tracking-widest text-[11px]">
            <section>
              ...
              <p>
                Ebanex International collects personal and institutional information necessary to
                deliver training programs, advisory services, and respond to inquiries. This
                includes information provided through contact forms, registration forms, and direct
                communication.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc ml-4 mt-2 space-y-2">
                ...
                <li>
                  Communicating directly with you in relation to your participation, inquiries, or
                  service delivery
                </li>
            ...
            <section>
              ...
              <p>
                We may engage trusted third-party service providers (such as hosting, email, or
                analytics providers) to support our operations. These providers are only given
                access to the information necessary to perform their functions and are required to
                maintain appropriate data protection standards.
              </p>
              <p className="mt-2">
                We do not share personal data with third parties for marketing or unrelated
                purposes.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                against unauthorized access, disclosure, alteration, or loss. This includes the use
                of secure systems and, where applicable, encrypted communications.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                which it was collected or to meet legal and operational requirements. Data that is
            ...
            <section>
              ...
              <p>
                If you have any questions about your data or would like to update or remove your
                information, you may contact us using the details below, and we will reasonably
                assist, subject to applicable legal and operational requirements.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Our website may use cookies to enhance user experience and analyze website usage.
