...
const Training: React.FC = () => {
    const categories = [
        ...
        },
        {
            ...
            items: [
                { name: 'Networking & Infrastructure', path: '/training/networking' },
                { name: 'Cloud Computing', path: '/training/cloud-computing' },
                { name: 'AI & Machine Learning', path: '/training/ai-tech' },
                { name: 'Systems Administration', path: '/training/systems-admin' },
            ],
        },
        {
            ...
            items: [
                { name: 'IT Governance', path: '/training/it-governance' },
                { name: 'Enterprise Risk Mgmt', path: '/training/risk-management' },
                { name: 'Internal Audit', path: '/training/internal-audit' },
                { name: 'Regulatory Compliance', path: '/training/compliance' },
            ],
        },
        {
            ...
            items: [
                { name: 'Strategic Management', path: '/training/strategic-thinking' },
                { name: 'Agile Leadership', path: '/training/leadership' },
                { name: 'Emotional Intelligence', path: '/training/communication' },
                { name: 'Team Development', path: '/training/team-development' },
            ],
        },
    ];
