      ...
      <div className="bg-black min-h-screen">
                ...
                <div className="relative z-10 space-y-3 sm:space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-3 border-t border-white/10">
                    ...
                    <div className="text-sm font-medium text-white">
                      <p className="text-[9px] sm:text-[10px] text-[#00C4D4] uppercase font-bold tracking-widest mb-0.5">
                        Target Audience
                      </p>
              ...
              {[
                {
                  ...
                  desc: 'Mapped to international frameworks and industry benchmarks',
                },
                {
                  icon: <FaClock />,
                  title: 'CPE Credits',
                  desc: 'Earn recognized Continuing Professional Education credits',
                },
                {
                  icon: <FaChalkboardTeacher />,
                  title: 'Expert-Led',
                  desc: 'Delivered by senior practitioners with real-world expertise',
                },
                {
                  icon: <FaLevelUpAlt />,
                  title: 'Skill Uplift',
                  desc: 'Designed for measurable career and institutional advancement',
                },
                {
                  icon: <FaLaptopCode />,
                  title: 'Hands-On Labs',
        ...
        <section id="overview" className="relative z-20 bg-black py-12 sm:py-16 overflow-hidden">
          ...
          <div className="w-full px-4 sm:px-6 lg:px-[100px] relative z-10">
            <motion.div {...fadeInUp}>
              <h2 className="text-xl sm:text-2xl font-bold text-white uppercase mb-6">
                Program Overview
              </h2>
                  ...
                  {isOverviewExpanded && (
                    ...
                    >
                      {remainingParagraphs.map((para, i) => (
                        <p
                          key={i}
                          className="text-slate-300 text-lg font-light leading-relaxed text-justify mt-8"
                        >
                          {para}
                        </p>
                      ))}
            ...
            >
              <svg viewBox="0 0 200 200" className="w-full h-full">
                ...
                <motion.circle
                  ...
                  r="40"
                  fill="none"
                  stroke="url(#waveGradientTemplate)"
                  strokeWidth="8"
                />
                <motion.circle
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-[100px] pt-20 pb-[10px] sm:py-20">
              <motion.div id="syllabus" className="mb-20">
                ...
                <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                  <div
                    className="p-8 shadow-2xl bg-[#0a1628]"
                    style={{
                      background: 'radial-gradient(circle at 50% 50%, #16476A 0%, #051020 100%)',
                    }}
                  >
                    ...
                    <ul className="space-y-4">
                      {program.skills.technical.map((skill, i) => (
                        <li
                          key={i}
                          className="flex items-start gap-3 text-white/80 font-medium text-sm sm:text-base leading-relaxed text-start"
                        >
          ...
          <section className="relative flex flex-col justify-center py-16 sm:py-24 w-full bg-[#00C4D4] sm:bg-[linear-gradient(135deg,#000000_50%,#00C4D4_50%)] overflow-visible z-20">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full relative z-10">
              <div className="relative w-full max-w-5xl flex flex-col lg:block items-center justify-center lg:justify-end mx-auto">
                ...
                >
                  <h2 className="text-xl font-black text-white uppercase mb-4 text-start">
                  ...
                  <div className="flex items-center gap-4 border-t border-white/10 pt-4">
                    <div className="text-left">
                      ...
                      <p className="text-[#00C4D4] text-[10px] font-bold uppercase tracking-widest mt-1">
                        {program.instructor.role}
                      </p>
                      <div className="flex flex-wrap gap-2 mt-3">
                        {program.instructor.certs.map((c) => (
                          <span
                            key={c}
                            className="bg-[#00C4D4] text-black px-2 py-0.5 text-[9px] font-black"
                          >
                            {c}
                          </span>
                        ))}
              ...
              <AnimatePresence initial={false}>
                {program.faqs.slice(0, showAllFaqs ? 99 : 3).map((faq, i) => (
                  ...
                  >
                    <motion.div
                      className={cn(
                        'relative overflow-hidden transition-all duration-300 border-[3px]',
                        openFaq === i
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <span
                            className={cn(
                              'w-8 h-8 sm:w-10 sm:h-10 border-2 border-black flex items-center justify-center text-xs sm:text-sm font-black transition-colors',
                              openFaq === i
                          ...
                          <span
                            className={cn(
                              'font-black uppercase text-xs sm:text-sm lg:text-base transition-colors pr-4',
                              openFaq === i
                                ? 'text-white'
                                : 'text-white/80 group-hover:text-[#00C4D4]',
                            )}
                          >
                            {faq.question}
                          </span>
                        ...
                        <div
                          className={cn(
                            'shrink-0 w-8 h-8 sm:w-10 sm:h-10 border-2 border-black flex items-center justify-center transition-colors',
                            openFaq === i
                              ? 'bg-black text-[#00C4D4]'
                        ...
                        {openFaq === i && (
                          ...
                          >
                            <div className="px-4 sm:px-6 pb-4 sm:pb-6 pl-[60px] sm:pl-[80px]">
                              <p className="text-white/90 font-medium text-xs sm:text-sm leading-relaxed text-start">
                                {faq.answer}
                              </p>
                            </div>
                          </motion.div>
            ...
            <div className="relative w-full max-w-4xl flex items-center justify-center lg:justify-start">
              ...
              >
                <div className="relative z-10 text-center sm:text-left">
                  <h2 className="text-xl sm:text-3xl lg:text-4xl font-black text-white leading-tight mb-4 uppercase tracking-tighter">
                    Ready to <span className="text-[#00C4D4]">Train</span> Your{' '}
                    <br className="hidden sm:block" /> Workforce?
                  </h2>
                  <p className="text-white/80 text-sm mb-8 leading-relaxed font-medium max-w-lg text-start">
                    Partner with Ebanex International to develop the technical capability and
