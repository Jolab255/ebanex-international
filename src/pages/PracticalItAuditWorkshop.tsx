...
import { sendPracticalItAuditWorkshopRegistration } from '../lib/api';
...
const PracticalItAuditWorkshop: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await sendPracticalItAuditWorkshopRegistration({
  ...
  const overviewParagraphs = [
    "As organizations navigate an increasingly hostile threat landscape, safeguarding data and systems has transcended IT departments to become a core business necessity. Ebanex International's Practical IT Audit Workshop training is designed specifically to bridge the gap between technical security principles and real-world workplace application.",
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <SEO
        title="Practical IT Audit Workshop | Ebanex International"
        description="Real-world cybersecurity skills for every professional. Register today for the Ebanex Practical IT Audit Workshop capacity building program."
        keywords="Practical IT Audit Workshop, Cybersecurity Training, IT audit, Tanzania, Ebanex, Capacity Building"
      />
          ...
          <div className="max-w-5xl">
            ...
            <div className="inline-block bg-black py-4 px-8 border border-white/10 mb-[-2rem] ml-4 lg:ml-0 relative z-50 shadow-2xl">
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black font-heading text-white uppercase tracking-tighter leading-[0.9]">
                Practical IT <span className="text-[#00BFFF]">Audit Workshop</span>
              </h1>
            </div>
            ...
            <div className="relative w-full flex flex-col lg:flex-row items-center">
              ...
              <div className="block md:hidden w-full px-4 mt-12 mb-[-4rem] relative z-20">
                <div className="relative aspect-video w-full">
                  ...
                  <img
                    src={cyberImg}
                    alt="Practical IT Audit Workshop"
                ...
                >
                  <div className="relative z-10">
                    <p className="text-base sm:text-lg text-white/90 font-medium leading-relaxed mb-8">
                      Secure your seat today. Complete the registration form to enroll in the Practical IT Audit Workshop Training hosted by Ebanex International in Zanzibar, Tanzania from 24 August to 28 August 2026.
                    </p>
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 border-t lg:border-t-0 lg:border-b border-white/10 pt-8 lg:pt-0 pb-0 lg:pb-8 order-2 lg:order-1">
                <div className="text-start">
                  ...
                  <h3 className="text-2xl sm:text-4xl font-black text-white uppercase tracking-tighter leading-none mb-3">
                    Practical IT <span className="text-[#00BFFF]">Audit Workshop</span> Training
                  </h3>
                ...
                {[
                  {
                    ...
                    value: 'TZS 1,200,000',
                    sub: 'Before 17th August 2026',
                    highlight: true,
                  },
                  {
                    label: 'Standard Fee',
                    value: 'TZS 1,300,000',
                    sub: 'After 17th August 2026',
                  },
                  {
                    label: 'Dates & Duration',
                    value: '24 Aug – 28 Aug 2026',
                    sub: '5 Full Days (40 CPE Hours)',
                  },
                  {
                    label: 'Venue',
                    value: 'Zanzibar',
                    sub: 'Zanzibar, Tanzania',
                  },
                ].map((info, idx) => (
                  <div
                    key={idx}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              ...
                              <span className="text-[10px] font-black text-[#00BFFF]">TZS 1.2M</span>
                            </div>
                            ...
                            >
                              ...
                              <span className="text-[10px] font-black text-slate-400">TZS 1.3M</span>
                            </div>
                          </div>
...
export default PracticalItAuditWorkshop;
