          ...
          <div className="absolute right-[-10px] lg:right-[-20px] top-1/2 -translate-y-1/2 z-10 w-[280px] sm:w-[350px] lg:w-[450px] aspect-[4/5]">
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                <div className="flex gap-2">
                  <a
                    href="https://tz.linkedin.com/in/enock-mwita-nkaina-b60648111"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 bg-black flex items-center justify-center hover:bg-[#00BFFF] hover:text-black text-[#00BFFF] transition-all border border-[#00BFFF]/20"
                  >
                ...
                <div className="bg-black p-2 border border-[#00BFFF]/30">
                  <p className="text-white font-black text-[9px] uppercase tracking-widest text-right">
                    Enock Nkaina
                  </p>
                </div>
              </div>
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="space-y-4">
                <blockquote className="text-sm sm:text-base font-medium text-white leading-relaxed relative italic">
                  <span className="text-[#00BFFF] text-4xl font-serif absolute -top-5 -left-3 opacity-30">
                    &ldquo;
                  </span>
                  ...
                  potential to build resilient institutions.
                </blockquote>
              ...
              <div className="space-y-4">
                <blockquote className="text-sm sm:text-base font-medium text-white leading-relaxed relative italic text-right">
                  ...
                  empowered people. Every training program we design and institution we strengthen
                  is a step toward a more secure global community.
                  <span className="text-[#00BFFF] text-4xl font-serif absolute -bottom-8 -right-3 opacity-30">
                    &rdquo;
                  </span>
                </blockquote>
