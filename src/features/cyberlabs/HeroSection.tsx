        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/60 leading-relaxed font-light border-l border-blue-500/20 pl-6 mb-12">
              State-of-the-art simulated environments where theory meets reality. 
              Develop elite technical skills through scenario-based learning and hands-on application.
            </p>
