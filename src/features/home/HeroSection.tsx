      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full">
        ...
        <div className="relative lg:grid lg:grid-cols-[minmax(0,1fr)_48%] gap-12 items-center">
          ...
          <div className="relative z-20 hidden lg:block">
            <div className="relative aspect-video lg:aspect-square xl:aspect-video bg-black rounded-none overflow-hidden group cursor-pointer shadow-none border-none">
                ...
                {!isPlaying && (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      {/* Radial Overlay like other cards */}
                      <div 
                      ...
                      <div className="relative z-10 flex flex-col items-center">
                        <div className="relative">
                          {/* Pulsing Glow - Square now */}
                          <div className="absolute inset-0 bg-black/20 rounded-none blur-2xl opacity-40 animate-pulse" />
                        ...
                        >
                          ...
                          <h3 className="text-[#00BFFF] font-black text-2xl mt-1 tracking-tighter uppercase">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-2 bg-white/20">
                      <div className="h-full bg-[#00BFFF] w-1/4 group-hover:w-full transition-all duration-1500" />
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>

              {/* Close Button - Visible when playing to "Stop" and show cover */}
              {isPlaying && (
                <button 
                  onClick={handleStopVideo}
                  className="absolute top-4 right-4 z-30 p-2 bg-black/50 hover:bg-[#00BFFF] text-white hover:text-black transition-colors rounded-none border border-white/10"
