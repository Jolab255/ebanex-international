...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pb-10 sm:pt-0 lg:pt-32 -mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full overflow-visible">
        ...
        <div className="relative z-10 mt-8 ">
          ...
          >
            <button className="h-12 sm:h-14 px-4 sm:px-6 lg:px-8 bg-blue-600 text-white rounded-sm font-bold text-[clamp(0.625rem,1.5vw,0.75rem)] uppercase tracking-[0.2em] hover:bg-blue-500 transition-all transform hover:-translate-y-1 shadow-xl active:scale-95">
